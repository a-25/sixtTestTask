...
class CarMKAnnotationTest: XCTestCase {
    ...
    func testTitle() {
        let titles = TestData.carAnnotationList.map{ $0.title }
        let resultTitles = [
            "make1, modelName1",
            "make2, modelName2",
            "make3, modelName3",
